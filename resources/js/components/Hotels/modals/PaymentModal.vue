...
export default {
  ...
  data() {
    return {
      ...
      component: () => import("../PaymentForm"), // mount payment form as default
    }
  },
  watch: {
    ...
    isValid(isValid) {
      if(isValid) {
        this.component = () => import("../PaymentLoading"); // if paymnet form is valid mount loading component

        setTimeout(() => {
          this.component = () => import("../PaymentCompleted");  // after 2 secs mount payment completed component
